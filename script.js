...
if (minute>=0 && minute<=15){
    console.log("Сейчас первая четверть часа.");
}else if(minute>15 && minute<=30){
    console.log("Сейчас вторая четверть часа.");
}else if(minute>30 && minute<=45){
    console.log("Сейчас третья четверть часа.");
}else{
    console.log("Сейчас четвёртая четверть часа.");
}
...
let num = prompt ("Прошу ввести целое число");
let znak;
let por;
...
if (Math.abs(num)/10<1){
    ...
    por = "трёхзначное и более";
};

console.log(`Число ${num} ${znak} ${por}`);

// Пример 4
// Создаются переменные red и yellow для красного и 
// жёлтого сигналов светофора соответств +енно.
